...
import com.example.homework.ui.theme.Grey700

@Composable
fun CryptoCurrencyItemView(data: CurrencyItem.CryptoCurrency) {
    ConstraintLayout(
        modifier = Modifier
            .fillMaxWidth()
            .height(60.dp)
        ...
        val (symbolLabel, nameLabel, idLabel, arrowIcon, divider) = createRefs()
        ...
        Text(text = data.name,
            ...
            modifier = Modifier
                .constrainAs(ref = nameLabel) {
                    ...
                    end.linkTo(anchor = idLabel.start, margin = 10.dp)
                    top.linkTo(anchor = parent.top)
                    bottom.linkTo(anchor = parent.bottom)
        ...
        Icon(painter = painterResource(id = R.drawable.baseline_arrow_forward_ios_24),
            ...
            modifier = Modifier
                .constrainAs(ref = arrowIcon) {
                    end.linkTo(anchor = parent.end, 10.dp)
                    top.linkTo(anchor = parent.top)
                    bottom.linkTo(anchor = parent.bottom)
                })
